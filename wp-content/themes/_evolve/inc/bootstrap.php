...
function theme_add_bootstrap() {
	...
	wp_enqueue_style( 'style-css', get_template_directory_uri() . '/style.css', array(), '1.5.0' );
        //wp_enqueue_style( '_evolve-style', get_stylesheet_uri() );

        wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', array('jquery'), '3.3.5', true );
        wp_enqueue_script( 'bootslider-js', get_template_directory_uri() . '/bootstrap/js/bootslider.js', array('jquery','bootstrap-js'), '3.3.5', true );
        
        wp_enqueue_script( '_evolve-custom', get_template_directory_uri() . '/js/custom.js', array('jquery','bootstrap-js','bootslider-js'), '1.5.0', true );
}
        ...
        foreach($sorted_menu_items as $i => $item) {
            ...
            if($item->menu_item_parent) {
                ...
                if( !in_array('dropdown', $sorted_menu_items[$parent_index]->classes) ) {
                    $sorted_menu_items[$parent_index]->classes[] = 'dropdown-item';
                }
            }
        }
